...
import {
  UploadCloud, FileText, X, Loader2, Download, Sparkles, AlertTriangle, CheckCircle2, RotateCcw, ArrowLeft, History,
} from "lucide-react";
  ...
  return (
    <Layout>
      <div className="mb-6 flex items-center justify-between">
        <Link to="/" className="inline-flex items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-foreground" data-testid="back-to-modules">
          <ArrowLeft className="h-4 w-4" /> Modules
        </Link>
        <Link to="/history" className="inline-flex items-center gap-2 border border-border bg-surface px-4 py-2 text-sm text-foreground transition-colors hover:bg-muted" data-testid="nav-history">
